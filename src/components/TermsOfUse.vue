...
제1조(목적)
본 회원약관은 sunpercent.com(회사명:은하수소프트 이하 '갑'라 한다)이 운영하는 인터넷관련 서비스(이하 '서비스'라 한다)를 이용함에 있어 관리자와 이용자(이하 '회원'라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 한다.
...
2.가입희망 회원은 반드시 자신의 전자우편주소로 이용신청을 하여야 하며, 1개의 ID만 신청을 할 수 있습니다.

제7조 (회원가입의 승낙)
'갑'의 회원 가입 신청 양식에 가입 희망 회원이 인터넷으로 제6조와 같이 신청하면 '갑'은 바로 가입을 승인하여 서비스를 이용할 수 있다.

제8조(회원가입 신청거절 및 강제 탈퇴)
1. '갑'은 타인의 명의나 전자우편주소를 도용하거나 가입신청양식에 반하여 회원가입신청을 할 경우 회원가입신청을 거절할 수 있다.
